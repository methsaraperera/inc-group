                ...
                if(mysqli_num_rows($q3)>0){
                    ...
                    echo '<div class="task-divider"></div> 
                        <div class="task-subheading">
                            <div>Here will be assignments details for each student and the instructor will be able to add, edit and remove assignments</div>
                    </div>';
                }
            }
            $assignmentsearch = mysqli_query($conn,"SELECT assignment_id FROM class_assignment WHERE classid='$classid';");
            if(mysqli_num_rows($assignmentsearch)>0){
                echo '<div class="task-subheading">
                <div>'. $subject ." ". $unit ." : ". $section ." - ". $classname ." ". $semester_term ." ". $semester_year . '</div>
                <div>Class 1 of 2</div> 
            </div>';
                /*while($newassignmentsearch = $assignmentsearch->fetch_assoc()){
                    $assignment_id = $newassignmentsearch['assignment_id'];
                    $assignment = mysqli_query($conn,"SELECT assignment_id FROM class_assignment WHERE classid='$classid';");
                }*/
            }
    ...
    <div class="right-panel">
        ...
        <div class="menu">
            ...
            <div class="rightbar-buttons">
                ...
                <div class="rightbar-divider"></div>
                <button class="rightbar-button" onclick=window.location.href="assignments.php">Addd an assignments</button>
