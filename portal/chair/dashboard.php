...
$uid = $_SESSION['userid']; // session key = user id which is used to access the database
                    ...
                    if (mysqli_num_rows($q2) > 0) {
                        while ($newq2 = $q2->fetch_assoc()) {
                            ...
                            '<div class="task-line">
                                ...
                                <div class="div4">
                                    <button class="task-btn" onclick="window.location.href=\'view-assignment.php?request='.$newq2['request_id'].'\'">
